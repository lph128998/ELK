...
const EDIT_CONFIG = exports.EDIT_CONFIG = {
  title: 'Edit the configuration',
  textPre: `If you're using an X-Pack secured version of Elastic Stack, you must specify` + ' credentials in the `apm-server.yml` config file.',
...
const IMPORT_DASHBOARD_UNIX = exports.IMPORT_DASHBOARD_UNIX = {
  title: IMPORT_DASHBOARD.title,
  textPre: IMPORT_DASHBOARD.textPre,
  commands: ['./apm-server setup']
};

const START_SERVER_UNIX = exports.START_SERVER_UNIX = {
...
const DOWNLOAD_SERVER_OSX = exports.DOWNLOAD_SERVER_OSX = {
...
const DOWNLOAD_SERVER_DEB = exports.DOWNLOAD_SERVER_DEB = {
  title: DOWNLOAD_SERVER_TITLE,
...
const DOWNLOAD_SERVER_RPM = exports.DOWNLOAD_SERVER_RPM = {
  title: DOWNLOAD_SERVER_TITLE,
...
const WINDOWS_SERVER_INSTRUCTIONS = exports.WINDOWS_SERVER_INSTRUCTIONS = [{
  title: DOWNLOAD_SERVER_TITLE,
