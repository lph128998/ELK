...
var EuiRadio = function EuiRadio(_ref) {
  var className = _ref.className,
      ...
      rest = _objectWithoutProperties(_ref, ['className', 'id', 'name', 'checked', 'label', 'onChange', 'disabled']);

  var classes = (0, _classnames2.default)('euiRadio', {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement('div', { className: 'euiRadio__circle' }),
    optionalLabel
  );
};
