...
var EuiIconTip = function EuiIconTip(_ref) {
  var type = _ref.type,
      ...
      color = _ref.color,
      rest = _objectWithoutProperties(_ref, ['type', 'aria-label', 'color']);

  return _react2.default.createElement(
    _tool_tip.EuiToolTip,
    rest,
    _react2.default.createElement(_icon.EuiIcon, { tabIndex: '0', type: type, color: color, 'aria-label': ariaLabel })
  );
};
